...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Yarn Spinner|Localisation", meta = (EditCondition = "!bAutoDetectCulture"))
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Yarn Spinner|Localisation|Fallback")
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Yarn Spinner|Localisation|Fallback", meta = (EditCondition = "bUseFallback"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Yarn Spinner|Localisation")
...
public:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Yarn Spinner|Localisation|Debug")
