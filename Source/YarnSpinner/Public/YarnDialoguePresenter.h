...
public:
	 ...
	 * presenter.
	 */
	UFUNCTION(BlueprintPure, Category = "Yarn Spinner|Presenter")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "Yarn Spinner|Auto Advance")
...
protected:
	...
	friend class UYarnDialogueInstance;
...
protected:
	...
	virtual bool CanHandleOptions() const { return true; }
...
protected:
	...
	FString ResolveShadowLineID(const FString& LineID) const;

	void FinalizeLocalizedLine(FYarnLocalizedLine& LocalizedLine, const FYarnLine& Line, const FString& EffectiveLineID, const FString& ResolvedText, const FString& LocaleCode) const;
